...
| $\color{#ffaa55}{\text{Gravity}}$ | 3 | ![](icons/sword.png)![](icons/axe.png)![](icons/bow.png) | Chance to send the target into the ground. | (15 + 5 * level)% chance to activate. (Melee) Swinging your weapon will also pull nearby enemies in closer. (Bow) Arrow will draw in nearby mobs. |
