...
| $\color{#ffff77}{\text{Unholy}}$ | 1 | ![](icons/sword.png)![](icons/axe.png)![](icons/spear.png) | Chance to turn slain enemies into an ally ghost. | 25% chance to activate. Only works on armorable monsters. Maximum of 8 ghosts at once. |
