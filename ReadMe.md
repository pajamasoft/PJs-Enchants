...
| $\color{#ffaa55}{\text{Blaze}}$ | 3 | ![][sword] | Swinging launches a small fireball. | Cooldown of (5 - level) seconds. |
| **NEW** $\color{#ffaa55}{\text{Blizzard}}$ | 3 | ![][sword] | Swinging launches a flurry of snow. | Cooldown of (5 - level) seconds. |
